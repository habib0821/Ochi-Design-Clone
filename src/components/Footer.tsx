...
const Footer = () => {
    return (
        <div className='p-20  font-["Founders Grotesk"] w-full flex gap-5 h-screen bg-zinc-900'>
            ...
            <div className="w-1/2">
                <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-5'>Presentation
                </h1>
                <div className="dets mt-5 font-['Nueu Montreal']">
